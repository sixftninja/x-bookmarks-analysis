...
Runs on Railway with a SQLite backend, exposed to Claude and ChatGPT via an MCP connector (`/mcp/sse`). Query, edit, tag, and add sources conversationally from any device.
